...
public class Register extends javax.swing.JFrame {
    ...
    // >>> added: label เตือนใต้ช่อง Confirm Password
    ...
    public Register(Login login) {
        ...
        // สร้าง JPopupMenu สำหรับ Numpad (Password)
        ...
        jTextFieldPW.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                int x = -numpadPanel.getPreferredSize().width;
                int y = 0;
        ...
        // สร้าง JPopupMenu สำหรับ Numpad (Confirm Password)
        ...
        numpadPane2.setPreferredSize(new Dimension(200, 200));
        numpadPopup1.add(numpadPane2);

        jTextFieldCPW .setFont(new java.awt.Font("Segoe UI", 0, 24));
        ...
        jTextFieldCPW.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                int x = -numpadPane2.getPreferredSize().width;
                int y = 0;
        ...
        // >>> added: ซ่อนป้ายเตือนเมื่อเริ่มพิมพ์ใหม่ (ทั้ง Password และ Confirm)
        javax.swing.event.DocumentListener hideErr = new javax.swing.event.DocumentListener() {
            private void hide() {
                confirmErrorLabel.setVisible(false);
                jTextFieldCPW.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0,0,0)));
            }
            public void insertUpdate(javax.swing.event.DocumentEvent e) { hide(); }
            public void removeUpdate(javax.swing.event.DocumentEvent e) { /* ไม่ซ่อนตอน clear ด้วยโค้ด */ }
            public void changedUpdate(javax.swing.event.DocumentEvent e) { }
        };
        jTextFieldPW.getDocument().addDocumentListener(hideErr);
        jTextFieldCPW.getDocument().addDocumentListener(hideErr);
        // <<< added
    }
    ...
    private void initComponents() {
        ...
        // >>> added: สร้าง label เตือน
        confirmErrorLabel = new javax.swing.JLabel();
        confirmErrorLabel.setFont(new java.awt.Font("Segoe UI", 0, 14));
        confirmErrorLabel.setForeground(new java.awt.Color(204, 0, 0));
        confirmErrorLabel.setText("Error: Confirm Password is not the same as Password.");
        confirmErrorLabel.setVisible(false);
        // <<< added
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    // >>> added: label เตือนใต้ช่อง Confirm (เยื้องให้เริ่มตรงกับช่องข้อความ)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(241, 241, 241)
                        .addGap(62, 62, 62) // 56 (ไอคอน) + 6 (ช่องว่าง)
                        .addComponent(confirmErrorLabel))
                    // <<< added
                    )
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        String Cpassword = jTextFieldCPW.getText().trim();

        // >>> added: เช็ค confirm ไม่ตรง
        confirmErrorLabel.setVisible(false);
        if (!password.equals(Cpassword)) {
            // แสดงป้ายใต้ Confirm + ขอบแดง + focus
            confirmErrorLabel.setVisible(true);
            jTextFieldCPW.requestFocus();
            jTextFieldCPW.setBorder(javax.swing.BorderFactory
        ...
        if (authService.register(userID, password , Cpassword)) {
            ...
            // เก็บรหัสไว้ให้แก้ ไม่ต้องล้างทุกช่อง
    ...
    private JPanel createRow(String[] keys, JTextField target, Runnable closeAction) {
        ...
        for (String k : keys) {
            ...
            switch (k) {
                case "Shift": button.setPreferredSize(new Dimension(85, 40)); break;
                case "Tab": button.setPreferredSize(new Dimension(70, 40)); break;
                case "Caps": button.setPreferredSize(new Dimension(80, 40)); break;
                case "Backspace": button.setPreferredSize(new Dimension(120, 40)); break;
                case "Enter": button.setPreferredSize(new Dimension(90, 40)); break;
                case "  ": button.setPreferredSize(new Dimension(300, 40)); break;
                case "/": button.setPreferredSize(new Dimension(48, 40)); break;
                default: button.setPreferredSize(new Dimension(50, 40)); break;
            }
                ...
                switch (k) {
                    ...
                    default: // ตัวอักษร/เลข
                        ...
                        if (ch.length() == 1 && Character.isLetter(ch.charAt(0))) {
                            if (shiftOn ^ capsOn) ch = ch.toUpperCase();
